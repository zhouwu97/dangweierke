...
# Fetch login.js with auth
js_url = f"{VPN}/http/77726476706e69737468656265737421e8f00f8f3e3c7d1e7b0c9ce29b5b/SyluTW/jscript/login.js"
r = s.get(js_url, timeout=15)
print(f"login.js: status={r.status_code}, len={len(r.text)}, ct={r.headers.get('Content-Type','')[:40]}")
